...
import SuperAdminExperimentDashboard from "./pages/SuperAdmin/Experiment/SuperAdminExperimentDashboard";
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "experiment", element: <SuperAdminExperimentDashboard /> },
    ],
  },
  {
    path: "*",
