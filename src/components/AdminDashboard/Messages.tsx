...
const MessageCounts = ({ messageCounts }) => (
  <div className="mb-6 flex justify-between">
    ...
    <div className="flex-1 bg-green-100 p-4 rounded-lg border border-green-300 shadow-sm text-center">
      <div className="flex flex-col items-center">
        <div className="flex items-center justify-center mb-2">
          <EnvelopeOpenIcon className="w-8 h-8 text-green-600" /> {/* Larger icon */}
          <p className="text-4xl font-bold text-black ml-2">{messageCounts.Read}</p> {/* Larger count */}
        </div>
        <p className="text-lg font-semibold text-green-600">Read</p> {/* Label below */}
      </div>
    </div>
    ...
    <div className="flex-1 bg-yellow-100 p-4 rounded-lg border border-yellow-300 shadow-sm mx-4 text-center">
      <div className="flex flex-col items-center">
        <div className="flex items-center justify-center mb-2">
          <InboxIcon className="w-8 h-8 text-yellow-600" /> {/* Larger icon */}
          <p className="text-4xl font-bold text-black ml-2">{messageCounts.Unread}</p> {/* Larger count */}
        </div>
        <p className="text-lg font-semibold text-yellow-600">Unread</p> {/* Label below */}
      </div>
    </div>
  </div>
);
