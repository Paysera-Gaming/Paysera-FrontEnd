...
export default function EmployeeEdit({ employee, onSubmit, isOpen, onClose }: EmployeeEditProps) {
  ...
  function handleSubmit(values: z.infer<typeof formSchema>) {
    if (values.firstName && values.lastName && values.department && values.role) {
      onSubmit(values);
      handleClose();
    } else {
